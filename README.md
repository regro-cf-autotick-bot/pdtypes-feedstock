...
Once the `conda-forge` channel has been enabled, `pdtypes` can be installed with:

```
conda install pdtypes
```

It is possible to list all of the versions of `pdtypes` available on your platform with:
